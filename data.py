...
LOCATIONS = [
    Location(
        "The Kettle & Crow",
        "Sable's tavern. Smells like bread and woodsmoke. The unofficial living room of the village.",
    ),
    Location(
        "Moss Square",
        "The open town center. A few benches, an old well nobody uses, and a notice board Pell maintains with excessive enthusiasm.",
    ),
    Location(
        "The Calloway Academy",
        "Wren's schoolhouse and lending library. Cramped, quiet, and smells like old paper.",
    ),
    Location(
        "Moss & Measure",
        "Aldric's general store. Ruthlessly organized. Everything has a price tag and a place.",
    ),
    Location(
        "Fenwick Meadow",
        "The grassy hillside at the edge of town. Wildflowers in spring, golden in summer, muddy in autumn.",
    ),
]
